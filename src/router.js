...
export const route = (data) => {
  ...
  if (Number.isFinite(Number(queries.id))) {
    ...
    render(pages.postList(data), data);
    window.onhashchange = () => {
